...
traitFilePath = "/gpfs/projects/bsc83/Projects/Breast/ANALYSIS/Hypertension/analysis/06_colocalization/SBP_Evangelou_parsed.txt" 
...
chrom = 10
colocStart = 102595108
colocStop = 102620555
#reference genome build: "hg19" or "hg38"
build = "hg19"
lead_SNP = "rs112184198" 
#"eqtl" or "sqtl"
qtlType = "eqtl"
#plink parameters
clump_P1 = 0.0000001
